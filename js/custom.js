...
$(function () {
    ...
    function createFullpage(Overflow) {
        $('#fullpage').fullpage({
            anchors: ['home', 'o-mnie', 'artist-section', 'sponsor-section', 'gallery-section', 'askus-section', 'contact-section'],
    ...
    (function ($, window, document, undefined) {
        ...
        $.fn.animatedBG = function (options) {
            var defaults = {
                colorSet: [''],  //background colours for home
                speed: 3000
            },
...
$('.about-section').ripples({
    resolution: 1024,
    dropRadius: 20,
    perturbance: 0.04
});
$('.model1-section').ripples({
    resolution: 1024,
    dropRadius: 20,
    perturbance: 0.04
});
